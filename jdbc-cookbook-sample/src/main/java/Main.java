...
public class Main {
    ...
    private static void create() {
        Recipe recipe = new Recipe("Kurczak z frytkami",30,"ziemniaki, pierś z kurczaka, zioła prowansalskie, oliwa",
                "Ziemniaki pokrój w słupki o grubości ok 1cm, " +
                        "możesz je zamarynować w oleju z ziołami i papryką, " +
                        "Pierś z kurczaka oczyść z błonek, pokrój w plastry " +
                        "i delikatnie rozbij.Zamarynuj w ulubionych przyprawach." +
                        "Rozgrzej piekarnik do temperatury 180 stopni, najpierw umieść " +
                        "na blaszce frytki, a po 20 minutach dorzuć kurczaka i piecz jeszcze " +
                        "20 minut(łącznie 40minut).Podawaj z ulubionym sosem lub keczupem.");
